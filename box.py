...
def apply_script(protocol, connection, config):
    ...
    class BoxMakerConnection(connection):
        ...
        def build_box_filled(self, x1, y1, z1, x2, y2, z2, color = None):
            build_filled(self.protocol, x1, y1, z1, x2, y2, z2, color or self.color, self.god, self.god_build)
        
        def build_box(self, x1, y1, z1, x2, y2, z2, color = None):
            build_empty(self.protocol, x1, y1, z1, x2, y2, z2, color or self.color, self.god, self.god_build)
